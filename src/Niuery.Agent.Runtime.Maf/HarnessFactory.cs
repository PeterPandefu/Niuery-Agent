...
{
    public static AIAgent CreateCoding(IChatClient client, IEnumerable<AITool> tools, string defaultMode = "plan") => new HarnessAgent(client, new HarnessAgentOptions
    {
        Name = "项目编码助手",
    ...
    public static AIAgent CreateChat(IChatClient client, IEnumerable<AITool> tools, bool hasWorkspace, string defaultMode = "plan") => new HarnessAgent(client, new HarnessAgentOptions
    {
        Name = "通用对话助手",
        AgentModeProviderOptions = CreateModeOptions(defaultMode),
